...
"""
If you want to remove an element from a list, you can use
the remove() method. The remove() method takes the value of
the element to remove as an argument:
"""
numbers = [10, 20, 30, 40, 50, 50]
numbers.remove(50)
print(numbers) # [10, 20, 30, 40, 50]
#we removed the another extra '50' value

#It is important to note that this method will only remove
#the first occurrence of an item. Not all of them:

#remove() fuction for lists only remove one value
numbers = [10, 20, 30, 40, 50, 50, 50]
numbers.remove(50)
print(numbers) # [10, 20, 30, 40, 50, 50]
#initially theres three 50 values and then we used remove
#now theres only two 50 values in the lists

#To remove an element at a specific index in the list, you
#can use the pop() method like this:
numbers = [1, 2, 3, 4, 5]
numbers.pop(1) # The number 2 is returned
print(numbers) # [1,3,4,5], we removed index 1 which is the 2 value

#If you don't specify an element for the pop method, then
#the last element is removed.
numbers = [1, 2, 3, 4, 5]
numbers.pop() # The number 5 is returned
print(numbers) #[1, 2, 3, 4], the last index value removed which is 5 because we didnt specify an index.

#If you need to empty the list, then you can use the clear()
#method like this:
numbers = [1, 2, 3, 4, 5]
numbers.clear()
